<aside class="main-sidebar sidebar-dark-primary elevation-4 ">
    @php
        ...
        } else if (in_array($user->role, ['pembimbing_instansi', 'pembimbing_kominfo'])) {
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if ($user->role == 'admin')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.surat-masuk.index') }}" class="nav-link {{ request()->routeIs('admin.surat-masuk.*') ? 'active' : '' }}">
                ...
                @if ($user->role == 'peserta')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('peserta.kegiatan.index') }}" class="nav-link {{ request()->routeIs('peserta.kegiatan.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('peserta.izin-cuti.index') }}" class="nav-link {{ request()->routeIs('peserta.izin-cuti.*') ? 'active' : '' }}">
                ...
                @if (in_array($user->role, ['pembimbing_instansi', 'pembimbing_kominfo']))
                    ...
                    <li class="nav-item">
                        <a href="{{ route($prefix . 'peserta.index') }}" class="nav-link {{ request()->routeIs([$prefix . 'peserta.index', $prefix . 'peserta.show']) ? 'active' : '' }}">
